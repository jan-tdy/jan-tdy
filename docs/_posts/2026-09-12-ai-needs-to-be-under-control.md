...
So for start, we need to realize that in the history of planet Earth (yes, humans have been on Earth for millions of years, but Earth is maybe 20x older), life was many times destroyed: asteroids, collisions, cold era more... But now we have made AI to destroy ourselves? No, thanks.
...
That is not all; let's say we are safe, but what about when an AI that is publicly available to everyone can crack any password in 1second? 
That way, passwords would have to be at least 200000 characters long... 
For those who have problems remembering 8-character passwords, this would be a nightmare.
OK, you can say that everyone would must use a password manager, but nope, that is not safe either; AI could crack even the whole password manager in seconds.

Now, I know that the things about passwords aren't based on much numbersand you can also say that the AI has some safeguards.
...
But those safeguards have a problem even now: if you ask for, let's say, just what is inside your fridge, and the AI says that, for safety reasons, it cannot access any camera named fridge...
